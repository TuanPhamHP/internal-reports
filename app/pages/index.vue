<template>
	<div class="px-3 py-3 max-w-7xl mx-auto">
		<p class="text-center text-black-700 text-2xl font-bold mt-10">
			Hệ thống báo cáo nhà làm
		</p>
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
			<div class="bg-neutral-primary-soft block p-6 border rounded border-default rounded-base shadow-xs">
				<svg class="w-7 h-7 mb-3 text-body" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
				...
				<button @click="$router.push('/reports/developers')"
			...
			<div class="bg-neutral-primary-soft block p-6 border rounded border-default rounded-base shadow-xs">
				<svg class="w-7 h-7 mb-3 text-indigo-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
				...
				<button @click="$router.push('/reports/kpi-bonus')"
					class="flex font-medium bg-indigo-600 text-white w-fit p-2 rounded items-center hover:bg-indigo-700 transition-colors">
					Tính KPI
					<svg class="w-4 h-4 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
						<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 14v4.833A1.166 1.166 0 0 1 16.833 20H5.167A1.167 1.167 0 0 1 4 18.833V7.167A1.166 1.166 0 0 1 5.167 6h4.618m4.447-2H20v5.768m-7.889 2.121 7.778-7.778" />
